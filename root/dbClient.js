...
var appDB = Object.create(null);
exports.getAppDb = function () {
    return appDB;
};
function InitDatabaseConnection() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    opt = { reconnectTries: Number.MAX_VALUE };
                    return [4 /*yield*/, MongoClient.connect(config_1.Config.dbHost, opt)];
                case 1:
                    appDB = _a.sent();
